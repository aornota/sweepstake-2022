module Aornota.Sweepstake2022.Ui.Pages.Chat.State

open Aornota.Sweepstake2022.Common.Delta
open Aornota.Sweepstake2022.Common.Domain.Chat
...
let [<Literal>] private CHAT_PREFERENCES_KEY = "sweepstake-2022-ui-chat-preferences"
