module Aornota.Sweepstake2022.Ui.Pages.News.State

open Aornota.Sweepstake2022.Common.Delta
open Aornota.Sweepstake2022.Common.Domain.News
...
let [<Literal>] private NEWS_PREFERENCES_KEY = "sweepstake-2022-ui-news-preferences"
