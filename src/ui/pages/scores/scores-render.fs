module Aornota.Sweepstake2022.Ui.Pages.Scores.Render
...
open Aornota.Sweepstake2022.Ui.Shared // note: after Aornota.Sweepstake2022.Common.Domain.Squad to avoid collition with Squad[Only]Dto
