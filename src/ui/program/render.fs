module Aornota.Sweepstake2022.Ui.Program.Render

open Aornota.Sweepstake2022.Common.Domain.Core
open Aornota.Sweepstake2022.Common.Domain.Draft
open Aornota.Sweepstake2022.Common.Markdown
open Aornota.Sweepstake2022.Common.UnitsOfMeasure
open Aornota.Sweepstake2022.Ui.Common.LazyViewOrHMR
open Aornota.Sweepstake2022.Ui.Common.Notifications
open Aornota.Sweepstake2022.Ui.Common.Render.Markdown
open Aornota.Sweepstake2022.Ui.Common.TimestampHelper
open Aornota.Sweepstake2022.Ui.Pages
open Aornota.Sweepstake2022.Ui.Program.Common
open Aornota.Sweepstake2022.Ui.Program.Markdown.Literals
open Aornota.Sweepstake2022.Ui.Render.Bulma
open Aornota.Sweepstake2022.Ui.Render.Common
open Aornota.Sweepstake2022.Ui.Shared
open Aornota.Sweepstake2022.Ui.Theme.Common
open Aornota.Sweepstake2022.Ui.Theme.Render.Bulma
open Aornota.Sweepstake2022.Ui.Theme.Shared
open Aornota.Sweepstake2022.Common.Domain.Squad // note: after Aornota.Sweepstake2022.Ui.Render.Bulma to avoid collision with Icon.Forward
open Aornota.Sweepstake2022.Common.Domain.User // note: after Aornota.Sweepstake2022.Ui.Render.Bulma to avoid collision with Icon.Password
...
let private renderHeader (useDefaultTheme, navbarBurgerIsActive, serverStarted:DateTimeOffset option, headerStatus, headerPages, _:int<tick>) dispatch =
    ...
    navbar theme navbarData [
        container (Fluid |> Some) [
            navbarBrand [
                yield navbarItem [ image "sweepstake-2022-24x24.png" (FixedSize Square24 |> Some) ]
                yield navbarItem [ [ str SWEEPSTAKE_2022 ] |> para theme { paraCentredSmallest with ParaColour = SemanticPara Black ; Weight = Bold } ]
    ...
    div divDefault [
        ...
        | AuthPage UserAdminPage ->
            ...
            | None ->
                ...
                yield lazyViewOrHMR renderSpecialNotificationMessage (useDefaultTheme, SWEEPSTAKE_2022, message, ticks)
...
let private renderFooter useDefaultTheme =
    ...
    footer theme true [
        container (Fluid |> Some) [
            [
                [ str "Written" ] |> link theme (NewWindow "https://github.com/aornota/sweepstake-2022") ; str " in "
...
let render state dispatch =
    div divDefault [
        ...
        | None -> ()
        yield lazyViewOrHMR2 renderNotificationMessages (state.UseDefaultTheme, SWEEPSTAKE_2022, state.NotificationMessages, state.Ticks) (DismissNotificationMessage >> dispatch)
