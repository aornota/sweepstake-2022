module Aornota.Sweepstake2022.Ui.Common.JsonConverter
...
(* Note: toJson/fromJson differ from Aornota.Sweepstake2022.Server.Common.JsonConverter because need to be inline (to keep Fable happy) - and work with string (rather than Json "wrapper")
